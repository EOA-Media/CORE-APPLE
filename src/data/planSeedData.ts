...
const incaTrailWorkouts: Workout[] = [
  {
    ...
    estimatedMinutes: 55,
    exercises: [
      makeExercise(ex("ATG Split Squat", "Quads", "Bodyweight", 3, 5, 5, 60), "inca-mon-ex-1"),
      ...
      makeExercise(ex("Single-Leg Calf Raises", "Calves", "Bodyweight", 3, 10, 10, 45), "inca-mon-ex-4"),
      makeExercise(ex("Patrick Step", "Knees", "Bodyweight", 3, 8, 8, 45), "inca-mon-ex-5"),
  ...
  },
  {
    ...
    exercises: [
      ...
      makeExercise(ex("ATG Split Squat", "Quads", "Bodyweight", 3, 5, 5, 60), "inca-wed-ex-2"),
      makeExercise(ex("Patrick Step", "Knees", "Bodyweight", 3, 8, 8, 45), "inca-wed-ex-3"),
      makeExercise(ex("Tibialis Raises", "Shins", "Bodyweight", 3, 25, 25, 45), "inca-wed-ex-4"),
      makeExercise(ex("Single-Leg Calf Raise", "Calves", "Bodyweight", 3, 10, 10, 45), "inca-wed-ex-5"),
  ...
  },
  {
    ...
    exercises: [
      ...
      makeExercise(ex("ATG Split Squat", "Quads", "Bodyweight", 3, 5, 5, 60), "inca-thu-ex-3"),
      makeExercise(ex("Tibialis Raises", "Shins", "Bodyweight", 3, 25, 25, 45), "inca-thu-ex-4"),
      makeExercise(ex("Single-Leg Calf Raises", "Calves", "Bodyweight", 3, 10, 10, 45), "inca-thu-ex-5"),
